...
const { group, fill, ifBreak, breakParent, indent, indentIfBreak, 
// label,
line, softline, hardline, lineSuffix, hardlineWithoutBreakParent, literallineWithoutBreakParent, } = doc_1.builders;
const space = ' ';
            ...
            if (ignoringNextStatement) {
                ...
                if (i < trees.length - 1 && !isIgnoreComment) {
                    ...
                    if ((allowTrailingSeparator ||
                        ...
                        const delimDoc = printToken(getGroupDelimToken(groupType));
                        results.push(
